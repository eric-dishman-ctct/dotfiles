...
(if (fboundp 'keymap-global-set)
    (progn
      (keymap-global-set "M-p" #'vader/previous-line)
      (keymap-global-set "M-n" #'vader/next-line))
  (global-set-key (kbd "M-p") #'vader/previous-line)
  (global-set-key (kbd "M-n") #'vader/next-line))

;; Custom scroll other window
(defun vader/scroll-other-window-down ()
  "Scroll the other window down by 10 lines."
  (interactive)
  (scroll-other-window '-10))
(defun vader/scroll-other-window-up ()
...
(if (fboundp 'keymap-global-set)
    (progn
      (keymap-global-set "C-M-v" #'vader/scroll-other-window-up)
      (keymap-global-set "C-M-S-v" #'vader/scroll-other-window-down))
  (global-set-key (kbd "C-M-v") #'vader/scroll-other-window-up)
  (global-set-key (kbd "C-M-S-v") #'vader/scroll-other-window-down))
...
(with-eval-after-load 'markdown-mode
  (define-key markdown-mode-map (kbd "M-p") 'vader/previous-line)
  (define-key markdown-mode-map (kbd "M-n") 'vader/next-line))
